...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
           <br/>
            <h1>Search</h1>
            <p>Here you can search our database of job profiles. Enter the title of a job you are interested in!</p>
            <hr>
            <form action="searchResults.php" method="post">
            	<input type="text" name="searchterm" placeholder="Search Term" style="width: 300px"/>
            </form>
      </div>
        <div class="col-sm-2 sidenav">
